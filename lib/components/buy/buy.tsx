  ...
  return (
    ...
    >
      <div
        ...
        className="aw-flex aw-min-h-[470px] aw-w-[90vw] aw-justify-center aw-overflow-clip aw-rounded-b-[10px] aw-bg-primary md:aw-w-full"
      >
        ...
        />
        {!isWalletConnected && (
          <div className="aw-flex aw-w-[90vw] aw-flex-col aw-items-center aw-justify-between aw-px-8 aw-pb-8 aw-pt-16 md:aw-w-full">
